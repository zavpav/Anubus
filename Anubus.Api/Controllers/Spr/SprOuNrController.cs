...
{
    public SprOuNrController(IDbAnubusContextFactory<IGrbsDbContext> dbContextFactory, ILogger logger)
    : base(dbContextFactory, logger, CreateMapperConfiguration(), x => x.SprOuNr)
    {
    }
